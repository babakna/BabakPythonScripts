...
class OllamaChatbot:
    ...
    def query_ollama(self, 
                    prompt: str, 
                    stream: bool = False,
                    context: List[int] = None) -> Optional[str] | Generator[str, None, None]:
    ...
    def _process_query_thread(self, query):
        try:
            if not self.current_context:
                # First query: generate similar questions and comprehensive response
                ...
                # Follow-up query: use conversation history as context
