...
class ETFOptimizerApp:
    ...
    def create_widgets(self):
        ...
        for i, header in enumerate(headers):
            ttk.Label(header_frame, text=header, style="Header.TLabel", width=widths[i]).grid(row=0, column=i, padx=5)
        ...
        self.clear_button = ttk.Button(button_frame, text="Clear Entries", command=self.clear_entries)
