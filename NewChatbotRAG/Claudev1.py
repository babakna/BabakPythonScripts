...
class RAGApplication:
    ...
    def create_widgets(self):
        ...
        self.run_btn = Button(button_frame, text="Run Query", command=self.threaded_run_query)
        self.run_btn.pack(side=LEFT, padx=5)
        
        self.clear_btn = Button(button_frame, text="Clear Output", command=self.clear_output)
        self.clear_btn.pack(side=LEFT, padx=5)
        
        self.exit_btn = Button(button_frame, text="Exit", command=self.cleanup_and_exit)
