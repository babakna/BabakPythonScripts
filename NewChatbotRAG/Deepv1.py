...
class RAGApplication:
    def __init__(self, root):
        ...
        self.llm_options = ["llama2", "mistral", "phi3"]  # Add more models as needed
    ...
    def upload_documents(self):
        ...
        if file_paths:
            ...
            if documents:
                ...
                self.update_output(f"Successfully ingested {len(documents)} documents")
        self.set_processing(False)
    ...
    def read_file(self, file_path):
        try:
            if file_path.endswith('.pdf'):
                ...
                return "\n".join(
                    [cell.value for sheet in wb.worksheets for row in sheet.values for cell in row]
                )
        except Exception as e:
