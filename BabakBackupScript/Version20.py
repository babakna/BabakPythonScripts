...
start_button = tk.Button(button_frame, text="Start Backup", command=on_start)
...
# Frame for destination, backup name, and select sources
...
backup_name_entry.grid(row=1, column=1, padx=5, sticky="w")

# Select Sources Button
select_sources_button = tk.Button(input_frame, text="Select Sources", command=select_sources)
select_sources_button.grid(row=2, column=0, columnspan=3, pady=5, sticky="w")
