...
backup_name_frame = tk.Frame(root)
backup_name_frame.pack(padx=10, pady=10)

tk.Label(backup_name_frame, text="Backup Name:").pack(side=tk.LEFT)
backup_name_var = tk.StringVar(value=default_backup_name)
backup_name_entry = tk.Entry(backup_name_frame, textvariable=backup_name_var, width=20)
backup_name_entry.pack(side=tk.LEFT, padx=5)
